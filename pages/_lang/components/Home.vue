    ...
    <div class="home-banner">
      <div class="home-banner-con">
        ...
        <div class="home-banner-con__buttons">
          <ul @click="showPlayer = true">
            <li class="circle-left"></li>
            <li class="icon">
              <img src="../../../assets/bf-icon@2x.png">
            </li>
            <li class="text">{{ $t('home.buttons.one') }}</li>
            <li class="circle-right"></li>
          </ul>
          <!-- <a :href="`/book_${this.locale}.pdf`" :download="`book_${this.locale}.pdf`"></a> -->
          <a href="/book_zh-cn.pdf" download="book_zh-cn.pdf">
            <ul>
              <li class="circle-left"></li>
              <li class="icon">
        ...
        <transition name="fade">
          <VideoPlayer class="home-banner-con__video"  v-show="showPlayer" v-model="showPlayer"/>
        </transition>
      </div>
    </div>
